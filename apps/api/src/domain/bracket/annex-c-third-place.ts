 ...
 *
 * AUTO-GENERATED — do not edit by hand. Source: the 495 official combinations
 * (C(12,8)) from the FWC 2026 regulations, one row per group-winner fixture.
 * Regenerate with apps/api/prisma/audit/gen-annex-c.mjs if the source changes.
 *
 * Keyed by the combination key = the 8 qualifying third-place group letters
 * sorted alphabetically and joined. Each value maps the WINNER group of a
 * best-third R32 fixture to the third-place group that the regulation places
 * against it. Winner group -> fixture is fixed:
 *   A->R32-79  B->R32-85  D->R32-81  E->R32-74
 *   G->R32-82  I->R32-77  K->R32-87  L->R32-80
 */
export const ANNEX_C_THIRD_PLACE: Record<string, Partial<Record<GroupLetter, GroupLetter>>> = {
...
/** Winner group letter -> the R32 best-third fixture it hosts (FWC 2026). */
export const ANNEX_C_FIXTURE_BY_WINNER: Partial<Record<GroupLetter, string>> = {
  A: 'R32-79', B: 'R32-85', D: 'R32-81', E: 'R32-74',
  G: 'R32-82', I: 'R32-77', K: 'R32-87', L: 'R32-80',
};
